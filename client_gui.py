...
class FirstRunDialog:
    ...
    def setup_ui(self):
        ...
        # 姓名标签 - 使用多行显示
        name_label_text = f"{self.get_text('name_label')}\n{self.get_text('name_label', 'vi')}\n{self.get_text('name_label', 'en')}"
        ...
        # 提示信息 - 三语言
        hint_text = f"{self.get_text('name_hint')}  |  {self.get_text('name_hint', 'vi')}  |  {self.get_text('name_hint', 'en')}"
        ...
        # 确定按钮（右）- 显示三语言
        confirm_text = f"{self.get_text('confirm')}/{self.get_text('confirm', 'vi')}/{self.get_text('confirm', 'en')}"
